              ...
              notifications.map((n) => {
                ...
                return (
                  <div
                    ...
                    className={`relative w-full text-left px-4 py-3 border-b border-gray-100 hover:bg-gray-50 transition-colors cursor-pointer ${
                  ...
                  >
                    <div className="flex gap-3">
                      ...
                      <div className="relative shrink-0">
                        ...
                        {menuOpenId === n.id && (
                          <div className="absolute right-0 mt-1 w-32 bg-white rounded-lg shadow-lg border border-gray-200 z-50 overflow-hidden">
                            <button
